...
# Transform ibm2 for no outliers
...
lm.best <- lm(nuvirdi ~ ibm2*matssvaedi+undirmatssvaedi+ibteg+teg_eign+fjeld+k.ar, data = trainBCAllIBM2)
Radj.allBcIBM2 <- CalculateRadjLambda(lm.allBcIBM2, testBCAllIBM2, lambdaAll) # 0.8880478 rétt: 0.8342736
Radj.best <- CalculateRadjLambda(lm.best, testBCAllIBM2, lambdaAll) 
