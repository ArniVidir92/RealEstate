...
lm.all <- lm(nuvirdi ~ kdagur + teg_eign + byggar + haednr + lyfta + ibm2 + fjhaed + fjbilast + fjbkar + fjsturt + fjklos + fjeld + fjherb + fjstof + fjgeym + stig10 + ibteg + k.ar, data = train)
names(summary(lm.all)$terms[2])

train2 <- subset(train, select=c("nuvirdi","kdagur","teg_eign","byggar","haednr","lyfta","ibm2","fjhaed",
                                          "fjbilast","fjbkar","fjsturt","fjklos","fjeld","fjherb",
                                          "fjstof","fjgeym","stig10","ibteg","k.ar"))
lm.all2 <- lm(nuvirdi ~ ., data = train2)
summary(lm.all2)
summary(lm.all)
...
lm.allYTransformed <- lm(nuvirdi ~ kdagur + teg_eign + byggar + haednr + lyfta + ibm2 + fjhaed + fjbilast + fjbkar + fjsturt + fjklos + fjeld + fjherb + fjstof + fjgeym + stig10 + ibteg + k.ar, data = trainTransf)
